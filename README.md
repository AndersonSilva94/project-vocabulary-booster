...
# Projeto Vocabulary Booster  :books:

### Décimo nono projeto do curso de Desenvolvimento Full Stack Web da Trybe.
...
1. Clone o repositório
  * `git clone git@github.com:AndersonSilva94/project-vocabulary-booster.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd project-vocabulary-booster`
